            ...
            <div className="container sectionabout p-2 " >
              <ol className="ccardds__container" title="Blog entries">
                ...
                <li className="ccardd">
                  <div className="ccardd__thumb">
                    <Slide direction='right'>
                      <img className="animate" src={Gajapati} alt='about'/></Slide>
                  </div>
                  <div className="ccardd__content">
                    <Slide direction='down'>
                ...
                <li className="ccardd">
                  <div className="ccardd__thumb">
                    <Slide direction='right'>
                      <img style={{ height: '500px' }} className="animate" src={Ganjam} alt='about' />
                    </Slide>
                  </div>
                  <div className="ccardd__content">
                    <Slide direction='down'>
                ...
                <li className="ccardd">
                  <div className="ccardd__thumb">
                    <Slide direction='right'>
                      <img style={{ height: '440px' }} className="animate" src={Jagatsinghpur} alt='about'/>
                    </Slide>
                  </div>
                  <div className="ccardd__content">
                    <Slide direction='down'>
                ...
                <li className="ccardd">
                  <div className="ccardd__thumb">
                    <Slide direction='right'>
                      <img style={{ height: '400px' }} className="animate" src={Jajpur} alt='about'/>
                    </Slide>
                  </div>
                  <div className="ccardd__content">
                    <Slide direction='down'>
                ...
                <li className="ccardd">
                  <div className="ccardd__thumb">
                    <Slide direction='right'>
                      <img style={{ height: '400px' }} className="animate" src={Kalahandi} alt='about'/>
                    </Slide>
                  </div>
                  <div className="ccardd__content">
                    <Slide direction='down'>
                ...
                <li className="ccardd">
                  <div className="ccardd__thumb">
                    <Slide direction='right'>
                      <img style={{ height: '400px' }} className="animate" src={Kandhamal} alt='about'/>
                    </Slide>
                  </div>
                  <div className="ccardd__content">
                    <Slide direction='down'>
                ...
                <li className="ccardd">
                  <div className="ccardd__thumb">
                    <Slide direction='right'>
                      <img style={{ height: '400px' }} className="animate" src={Kendrapara} alt='about'/>
                    </Slide>
                  </div>
                  <div className="ccardd__content">
                    <Slide direction='down'>
                ...
                <li className="ccardd">
                  <div className="ccardd__thumb">
                    <Slide direction='right'>
                      <img style={{ height: '500px' }} className="animate" src={Khordha} alt='about'/>
                    </Slide>
                  </div>
                  <div className="ccardd__content">
                    <Slide direction='down'>
                ...
                <li className="ccardd">
                  <div className="ccardd__thumb">
                    <Slide direction='right'>
                      <img style={{ height: '500px' }} className="animate" src={Koraput} alt='about'/>
                    </Slide>
                  </div>
                  <div className="ccardd__content">
                    <Slide direction='down'>
