                  ...
                  <div className="row justify-content-center ">
                    <div classname="swiper-wrapper d-flex align-items-center">
                      ...
                      >
                        ...
                        <SwiperSlide>
                          <img src={k1} height="250" width="100%" alt='gallery'/>
                          <h5
                            style={{
                              textAlign: "center",
                              margin: "5px",
                        ...
                        <SwiperSlide>
                          <img src={k2} height="250" width="100%" alt='gallery'/>
                          <h5
                            style={{
                              textAlign: "center",
                              margin: "5px",
                        ...
                        <SwiperSlide>
                          <img src={k3} height="250" width="100%" alt='gallery'/>
                          <h5
                            style={{
                              textAlign: "center",
                              margin: "5px",
                        ...
                        <SwiperSlide>
                          <img src={k4} height="250" width="100%" alt='gallery'/>
                          <h5
                            style={{
                              textAlign: "center",
                              margin: "5px",
                        ...
                        <SwiperSlide>
                          <img src={k5} height="250" width="100%" alt='gallery'/>
                          <h5
                            style={{
                              textAlign: "center",
                              margin: "5px",
                        ...
                        <SwiperSlide>
                          <img src={k6} height="250" width="100%" alt='gallery'/>
                          <h5
                            style={{
                              textAlign: "center",
                              margin: "5px",
                        ...
                        <SwiperSlide>
                          <img src={k7} height="250" width="100%" alt='gallery'/>
                          <h5
                            style={{
                              textAlign: "center",
                              margin: "5px",
                        ...
                        <SwiperSlide>
                          <img src={k8} height="250" width="100%" alt='gallery'/>
                          <h5
                            style={{
                              textAlign: "center",
                              margin: "5px",
                        ...
                        <SwiperSlide>
                          <img src={k9} height="250" width="100%" alt='gallery'/>
                          <h5
                            style={{
                              textAlign: "center",
                              margin: "5px",
